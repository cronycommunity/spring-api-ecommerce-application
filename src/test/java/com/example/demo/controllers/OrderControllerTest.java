...
public class OrderControllerTest {
    ...
    public void setup(){
        ...
        when(userRepository.findByUsername("mete")).thenReturn(user);
    ...
    public void verify_submit(){
        ...
        ResponseEntity<UserOrder> response = orderController.submit("mete");
    ...
    public void verify_getOrdersForUser(){
        ...
        ResponseEntity<List<UserOrder>> response = orderController.getOrdersForUser("mete");
        assertNotNull(response);
        assertEquals(200, response.getStatusCodeValue());
